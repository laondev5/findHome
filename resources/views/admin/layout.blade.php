...
<body class="overflow-hidden">
  ...
  <header >
    ...
    <nav
      id="sidenav-1"
      class="fixed left-0 top-0 z-[1035] h-screen w-60 -translate-x-full overflow-hidden bg-blue-600 shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)]  xl:data-[te-sidenav-hidden='false']:translate-x-0"
      ...
      <a
        ...
        <!-- <img
          ...
          alt="TE Logo"
          draggable="false" /> -->
        <span class="text-[16px] text-white font-semibold">Transcribing</span>
      </a>
    ...
    <nav
      id="main-navbar"
      class="fixed left-0 right-0 top-0 flex w-full flex-nowrap items-center justify-between bg-white py-[0.6rem] text-gray-500 shadow-lg hover:text-gray-700 focus:text-gray-700  lg:flex-wrap lg:justify-start xl:pl-60"
      data-te-navbar-ref>
      <!-- Container wrapper -->
      <div
          ...
          <li class="relative" data-te-dropdown-ref>
            <a
              ...
              <!-- <img
                ...
                alt="Avatar"
                loading="lazy" /> -->
                <span class="py-3 px-4 border rounded-md">
  ...
  <!--Main layout-->
  <main style="margin-top: 67px; margin-left: 50px">
    <div class="ml-[190px]">
        @yield('admin')
    </div>
  </main>
